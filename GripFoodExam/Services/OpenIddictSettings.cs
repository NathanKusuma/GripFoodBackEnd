namespace GripFoodExam.Services
{
    public static class OpenIdSettings
    {
        public static class Endpoints
        {
            public const string Authorization = "connect/authorize"; //untuk melakukan login

            public const string Introspection = "connect/introspect";//untuk cek token

            public const string Token = "connect/token"; //untuk tukar menukar token

            public const string Userinfo = "connect/userinfo"; //untuk get userinfo

            public const string Revoke = "connect/revoke"; //untuk delete token

            public const string Logout = "connect/logout"; //untuk melakukan logout
        }
